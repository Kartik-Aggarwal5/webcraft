    ...
    <Container>
      <div className="flex flex-col items-center text-center">
        <div className="max-w-[950px] w-full flex flex-col items-center">
          <h1 className="text-[62px] sm:text-[48px] xs:text-[36px] xs:leading-tight font-extrabold leading-[75px] heading-clip my-6">
          We Craft Exceptional Digital Experiences
          </h1>
          <p className="text-[#81AFDD] sm:text-[18px] xs:text-[14px] max-w-[660px] text-[20px] my-6">
          ...
          <form
            onSubmit={openForm}
            className="max-w-[650px] w-full mt-12 flex items-center">
            <input
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              placeholder="Your Email Address"
              className="bg-[#052D56] py-5 px-5 outline-none w-full border-l-rounded-lg rounded-md "
              type="email"
            />
            <button
              onClick={openForm}
              type="submit"
              className="py-5 w-[50%] bg-[#FF4820] font-medium rounded-md"
            >
              Get Started
            </button>
          </form>
